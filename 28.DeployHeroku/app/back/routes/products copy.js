...
//2. Встановлюємо з"єднання ВКАЗАТИ КОРИСТУВАЧА І ПАРОЛЬ У СВОЄМУ РЯДКУ ПІДКЮЧЕННЯ
mongoose.connect("mongodb+srv://КОРИСТУВАЧ:ПАРОЛЬ@cluster0-g8yh7.mongodb.net/НАЗВА_БАЗИ_ДАНИХ?retryWrites=true&w=majority", {
